...
export default function Home() {
  ...
  async function login() {
    const email = window.prompt('Responder email');
    const password = window.prompt('Responder password');
    if (!email || !password) { setNotice('Enter your configured responder credentials to continue.'); return; }
    ...
    if (data.access_token) { setToken(data.access_token); setDashboard(true); setNotice('Responder session active.'); }
    else setNotice('Login failed: check the configured responder credentials.');
  }
